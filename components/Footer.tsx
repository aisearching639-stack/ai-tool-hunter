type Dict = { footer?: { copyright?: string } }
export default function Footer({ dict }: { dict?: Dict }) {
  return (
    <footer className="mt-16 border-t border-white/5 bg-surface-darker py-12">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <p className="text-sm text-gray-500">{dict?.footer?.copyright ?? '© 2025 AI Tool Hunter'}</p>
