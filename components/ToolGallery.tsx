export default function ToolGallery({ mainMediaUrl, screenshots }: { mainMediaUrl: string; screenshots: string[] }) {
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-96 md:h-80">
        <div className="md:col-span-2 relative group rounded-xl overflow-hidden border border-[#333] bg-black">
          ...
          <div className="absolute bottom-4 left-4"><span className="px-2 py-1 rounded bg-black/60 text-xs font-bold text-white backdrop-blur">Promotional Video</span></div>
        </div>
