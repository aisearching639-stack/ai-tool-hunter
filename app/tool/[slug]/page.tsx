...
export default function ToolDetailPage() {
  const mockToolData = {
    breadcrumbs: [
      { label: 'Home', href: '/' },
      { label: 'Generative Art', href: '/category' },
      { label: 'Midjourney' },
    ],
    title: 'Midjourney',
    logoUrl:
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="p-4 rounded-xl border border-border-dark bg-gradient-to-br from-[#121212] to-[#1A1A1A]">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg cursor-pointer transition-colors group"><div className="size-8 rounded bg-white flex items-center justify-center text-black font-bold">D</div><div className="flex-1"><p className="text-sm font-bold text-white group-hover:text-primary transition-colors">DALL-E 3</p><p className="text-xs text-text-light">OpenAI</p></div><span className="material-symbols-outlined text-text-light text-sm">arrow_forward</span></div>
                    <div className="flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg cursor-pointer transition-colors group"><div className="size-8 rounded bg-gradient-to-br from-orange-500 to-pink-500 flex items-center justify-center text-white font-bold">S</div><div className="flex-1"><p className="text-sm font-bold text-white group-hover:text-primary transition-colors">Stable Diffusion</p><p className="text-xs text-text-light">Stability AI</p></div><span className="material-symbols-outlined text-text-light text-sm">arrow_forward</span></div>
                  </div>
                </div>
              </div>
            </div>
